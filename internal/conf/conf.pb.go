...
type Server struct {
	...
	Jager *Server_Jager `protobuf:"bytes,3,opt,name=jager,proto3" json:"jager,omitempty"`
}
...
func (x *Server) GetJager() *Server_Jager {
	if x != nil {
		return x.Jager
	}
	return nil
...
func (x *Server_Jager) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Jager) ProtoMessage() {}

func (x *Server_Jager) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Jager.ProtoReflect.Descriptor instead.
func (*Server_Jager) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 2}
}

func (x *Server_Jager) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x85, 0x03, 0x0a,
	...
	0x63, 0x12, 0x2e, 0x0a, 0x05, 0x6a, 0x61, 0x67, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x18, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65,
	0x72, 0x76, 0x65, 0x72, 0x2e, 0x4a, 0x61, 0x67, 0x65, 0x72, 0x52, 0x05, 0x6a, 0x61, 0x67, 0x65,
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x1b, 0x0a, 0x05, 0x4a, 0x61, 0x67, 0x65, 0x72,
	0x12, 0x12, 0x0a, 0x04, 0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x61, 0x64, 0x64, 0x72, 0x22, 0xdd, 0x02, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a,
	...
	0x65, 0x6f, 0x75, 0x74, 0x42, 0x18, 0x5a, 0x16, 0x66, 0x6f, 0x6f, 0x2f, 0x69, 0x6e, 0x74, 0x65,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_Jager)(nil),        // 5: kratos.api.Server.Jager
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	5,  // 4: kratos.api.Server.jager:type_name -> kratos.api.Server.Jager
